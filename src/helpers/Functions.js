// In this file we are going to put all the functions that could be reused in the whole project........

function getSVGForPassword(checked) {
    return (
        <svg
            version="1.1"
